  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading">Cars options page</div>
        <div class="panel-body">

        @include('errors.errorlist')

{!! Form::open(array('url' => 'cars', 'method' => 'POST', 'class' => 'form-horizontal')) !!}
	<ul>
		<li>
		...
		<li>
			...
			{!! Form::text('inscription_date', null, 
                    array(
		...
		<li>
			...
			{!! Form::text('production_date', null, 
                    array(
                          'class'=>'form-control datepicker', 
                          'id'=>'')) !!}
		</li>
